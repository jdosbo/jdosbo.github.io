...
\begin{enumerate}
	...
	\item {\textbf{\textit{Implementation of ACTS into sPHENIX track reconstruction.}}} J. D. Osborn et al. Computing and Software for Big Science 5, 23 (2021).
...
\begin{enumerate}
	\normalsize
		...
		\item Searches for 25 rare and forbidden decays of $D^+D_s^+ $ mesons. JHEP 06, (2021) 044
		\item \textbf{\textit{Probing gluon spin-momentum correlations in trasversely polarized protons through midrapidity isolated direct photons in $p^\uparrow+p$ collisions at $\sqrt{s}=200$ GeV.}} Phys. Rev. Lett. 127, 162001 (2021).
