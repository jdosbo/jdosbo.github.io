...
\begin{enumerate}
	...
	accepted by Computing and Software for Big Science.
	\item U. A. Acharya et al. (PHENIX Collaboration), ``Probing gluon spin-momentum correlations in transversely polarized protons through midrapidity isolated direct photons in $p^\uparrow+p$ collisions at $\sqrt{s}=200$ GeV. arXiv:2102.13585, accepted by Phys. Rev. Lett.
...
\begin{flushleft}
	...
	\begin{enumerate}
		...
		\item Streaming Readout 9 Workshop, virtual, December, 2021.
...
\begin{flushleft}
	...
	\normalsize
	\begin{enumerate}
		\item Probing QCD at High Energy and Density with Jets INT Workshop, August 16-20, 2021. ``Probing nucleon structure with jets: results and future plans.''
...
Sebastian Araya - Acts tracking in ECCE. \\
...
\begin{enumerate}
	...
	\item {\textbf{\textit{Implementation of ACTS into sPHENIX track reconstruction.}}} J. D. Osborn et al., arXiv:2103.06703. Accepted by Computing and Software for Big Science.
...
\begin{enumerate}
	\normalsize
		\item \textbf{\textit{Probing gluon spin-momentum correlations in trasversely polarized protons through midrapidity isolated direct photons in $p^\uparrow+p$ collisions at $\sqrt{s}=200$ GeV.}} U. A. Acharya et al, arXiv:2012.13585. Accepted by Phys. Rev. Lett.
